...
Project GitHub subdirectory URL: https://github.com/addiittiii/d2mr_transpose_to_quarto_aditij

URL or instructions to access additional materials, if needed:
I have made a separate repository for this mini project. I have added both Yuchen and Natalie as collaborators on that repo. 
...
1. Did you complete the project with direct collaborators or general support? If so, who did you collaborate with and what was/were their contribution(s)?
    ...
    2. General support (students who helped you with debugging, conceptual understanding, or the like) and their contributions: Deeksha helped me debug a plotting problem that I was having with my correlation plot. Since she is making a ggplot2 theme based mini project, she pointed out my mistake in sequencing the layers of the plot and the formatting of the same.
2. Did you use LLMs or other AI models to generate text or code for this project? If so, which tools did you use and how did you use them? Remember in this class you *are* allowed (even encouraged) to use these tools for help with coding, but not for writing text. This can be very brief, just one or two sentences is fine unless you have more you'd like to add.
    1. answer here : I used chatGPT ocassionally to debug especially ggplot sequences since I was having some troubles in the same
...
1.  use frequent, informative comments in code and markdown
- I have used comments throughout the code and have documented all the functions that I created and used 

10. determine when code is better suited for a sourced script vs. a notebook chunk and source scripts appropriately
- I sourced my own plotting function in this mini project and I feel using that function made my life so much easier. I did not have to worry about all the layers and syntax errors which come with making multi-variable graphs and sourcing that function gave me better looking graphs as well!
Moreover, I think for complex functions which includes many layers, it is best to source them because it makes the markdown file look much more cleaner and well-organized.


16. determine most appropriate visualizations and analyses for specific research questions and data
In my previous paper, I had no visualizations for any of the results. But this time I analysed which questions requires what type of visualization. For eg. for the hypothesis whether trust and satisfaction scores are significantly correlated for LDR vs. GCR, I used a scatter plot. Then
I also used box plots for ANOVA between relationship duration and trust and satisfaction scores for both the groups. Specifically, creating straightforward tables (which lacked in my previous paper) helped me determine which visualization would best suit my analyses.
...
-   Additional points (up to 20): 15
-   TA provisional engagement points (up to 10): 7
-   Final approved engagement points (up to 10): 7
-   Total points (up to 50): 24 (would be 37 but you've maxed out all categories!) 
...
Additional comments: 
ND: WOW!!! This is awesome, Aditi! Talk about going above and beyond.
